    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-2">
          <div className="h-6 w-52 rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
          <div className="h-4 w-[420px] max-w-full rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
        </div>
        <div className="flex items-center gap-2">
          <div className="h-9 w-24 rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
          <div className="h-9 w-40 rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
        </div>
      </div>

      <section className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 space-y-4 transition-colors duration-200">
        <div className="space-y-2">
          <div className="h-4 w-44 rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
          <div className="h-3 w-[520px] max-w-full rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="space-y-2">
              <div className="h-3 w-24 rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
              <div className="h-10 w-full rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
            </div>
          ))}
        </div>
        <div className="h-10 w-28 rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
      </section>
      ...
      <section className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 space-y-3 transition-colors duration-200">
        <div className="space-y-2">
          <div className="h-4 w-28 rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
          <div className="h-3 w-[520px] max-w-full rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
        </div>
        <div className="h-10 w-full rounded bg-zinc-100 dark:bg-zinc-900 medichat-skeleton" />
      </section>
